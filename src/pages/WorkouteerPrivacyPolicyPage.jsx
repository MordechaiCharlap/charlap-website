...
const WorkouteerPrivacyPolicyPage = () => {
  return (
    <div className="websiteLayout">
      <div>
        <h1>Workouteer app/website Privacy policy</h1>
        <p>
          Workouteer operates the workouteer.co.il website, which provides the
          SERVICE.
        </p>
        <p>
          This page is used to inform website visitors regarding our policies
          with the collection, use, and disclosure of Personal Information if
          anyone decided to use our Service, the Workouteer website.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at workouteer.co.il, unless
        ...
        <p>
          ...
          phone number, and postal address. The information that we collect will
          be used to contact or identify you.
        </p>
        <p>
          Log Data We want to inform you that whenever you visit our Service, we
        ...
        <p>
          ...
          from the website that you visit and are stored on your computer's hard
          drive.
        </p>
        <p>
        ...
        <p>
          Security We value your trust in providing us your Personal
        ...
        <p>
          Links to Other Sites Our Service may contain links to other sites. If
          you click on a third-party link, you will be directed to that site.
        ...
        <p>
          Children's Privacy Our Services do not address anyone under the age of
        ...
        <p>
          ...
          time to time. Thus, we advise you to review this page periodically for
...
export default WorkouteerPrivacyPolicyPage;
